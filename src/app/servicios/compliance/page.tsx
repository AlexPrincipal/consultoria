          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
               <Card className="w-full max-w-md bg-card border-border/50 shadow-xl">
                <CardHeader>
                  <CardTitle className="text-2xl font-headline text-center text-white">Evalúe su riesgo actual</CardTitle>
                </CardHeader>
                <CardContent>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <Card className="bg-card/50 p-6 border-white/10">
              <h3 className="font-semibold text-xl mb-2 text-white">Responsabilidad Penal</h3>
            ...
            <Card className="bg-card/50 p-6 border-white/10">
              <h3 className="font-semibold text-xl mb-2 text-white">Supervisión y Auditoría</h3>
             ...
             <Card className="bg-card/50 p-6 border-white/10">
              <h3 className="font-semibold text-xl mb-2 text-white">Políticas y Procedimientos</h3>
        ...
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
          ...
          <div className="text-left mx-auto max-w-2xl bg-card/80 border border-white/10 p-8 rounded-lg">
                <blockquote className="text-lg italic text-white border-l-2 border-primary pl-4">
                  "La implementación del programa de compliance nos abrió las puertas a licitaciones gubernamentales que antes eran inaccesibles. Su trabajo fue fundamental."
                </blockquote>
