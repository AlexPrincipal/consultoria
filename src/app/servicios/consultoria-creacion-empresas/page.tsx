        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <Card className="bg-card p-6">
              <h3 className="font-semibold text-xl mb-2">Requisitos y Constitución</h3>
            ...
            <Card className="bg-card p-6">
              <h3 className="font-semibold text-xl mb-2">Representación ante IMM</h3>
            ...
            <Card className="bg-card p-6">
              <h3 className="font-semibold text-xl mb-2">Estructura Societaria</h3>
