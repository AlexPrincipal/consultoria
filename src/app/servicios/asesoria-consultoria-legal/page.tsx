...
export default function AsesoriaPage() {
    ...
    const contentRef = useMemoFirebase(
      () => (firestore ? doc(firestore, 'content', 'asesoria-consultoria-legal') : null),
      [firestore]
    );
    ...
    const defaultContent = {
      ...
      description: "Ofrecemos orientación sobre derechos, responsabilidades y regulaciones aplicables, asimismo nos centramos en la estrategia y la resolución de problemas complejos o el diseño de proyectos a largo plazo en materia empresarial o de negocios.",
      formTitle: "Inicie su consulta estratégica",
      sectionTitle: "Nuestra Consultoría Estratégica",
      service1Title: "Orientación Normativa Clara",
      service1Description: "Analizamos a fondo la legislación aplicable a su industria para que opere con certeza, minimizando riesgos y asegurando el cumplimiento en cada decisión.",
      service2Title: "Diseño de Estrategias de Negocio",
      service2Description: "Le acompañamos en el diseño de proyectos empresariales, fusiones, adquisiciones y reestructuraciones, alineando la estructura legal con sus objetivos de crecimiento.",
      service3Title: "Resolución de Problemas Complejos",
      service3Description: "Nos anticipamos a los conflictos. Brindamos asesoramiento para solucionar disputas complejas de manera eficiente, protegiendo sus relaciones comerciales y evitando litigios costosos.",
    ...
    const serviceSchema = getServiceSchema('asesoria-consultoria-legal');

  return (
    <div className="bg-background text-white">
      <Script id="service-schema-asesoria" type="application/ld+json" strategy="afterInteractive">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl font-bold font-headline">
                <EditableText
                  ...
                  docId="asesoria-consultoria-legal"
                />
              </h1>
