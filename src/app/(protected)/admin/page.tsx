...
// Updated schema to include all editable fields for the homepage
const homeContentSchema = z.object({
  ...
  heroBackgroundImageUrl: z.string().url("Debe ser una URL válida."),
  ...
  testimonialQuote: z.string().min(1, "La cita es requerida."),
  testimonialClientName: z.string().min(1, "El nombre del cliente es requerido."),
  testimonialClientLogoUrl: z.string().url("Debe ser una URL de logo válida."),

  contactUsTitle: z.string().min(1, "El título de contacto es requerido."),

  footerAddress: z.string().min(1, "La dirección es requerida."),
  footerMissionLinkText: z.string().min(1, "Texto requerido."),
  footerValuesLinkText: z.string().min(1, "Texto requerido."),
  footerContactLinkText: z.string().min(1, "Texto requerido."),
});
...
export default function AdminPage() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Card className="bg-card/50 border-border/50">
        <CardHeader>
          <CardTitle>Gestión de Contenido: Página de Inicio</CardTitle>
          <CardDescription>
            Modifique los textos e imágenes que se muestran en la página principal. Los cambios se reflejarán inmediatamente después de guardar.
          </CardDescription>
        </CardHeader>
        <CardContent>
            <Accordion type="single" collapsible className="w-full space-y-4" defaultValue="item-1">
                ...
                <AccordionItem value="item-1">
                    <AccordionTrigger className="text-lg font-semibold text-primary p-4 bg-card rounded-md">Sección Principal (Hero)</AccordionTrigger>
                    <AccordionContent className="p-4 border rounded-md border-border/50 mt-2 space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="heroBackgroundImageUrl" {...register('heroBackgroundImageUrl')} placeholder="https://example.com/image.jpg" />
                            {errors.heroBackgroundImageUrl && <p className="text-destructive text-sm">{errors.heroBackgroundImageUrl.message}</p>}
                        </div>
                    </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-2">
                     <AccordionTrigger className="text-lg font-semibold text-primary p-4 bg-card rounded-md">Sección de Servicios</AccordionTrigger>
                     <AccordionContent className="p-4 border rounded-md border-border/50 mt-2 space-y-6">
                        <div className="space-y-2">
                ...
                <AccordionItem value="item-3">
                    <AccordionTrigger className="text-lg font-semibold text-primary p-4 bg-card rounded-md">Sección de Testimonios</AccordionTrigger>
                    <AccordionContent className="p-4 border rounded-md border-border/50 mt-2 space-y-4">
                         <div className="space-y-2">
                            <Label htmlFor="testimonialQuote">Cita del Testimonio</Label>
                            <Textarea id="testimonialQuote" {...register('testimonialQuote')} />
                            {errors.testimonialQuote && <p className="text-destructive text-sm">{errors.testimonialQuote.message}</p>}
                        </div>
                         <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="testimonialClientName">Nombre del Cliente</Label>
                                <Input id="testimonialClientName" {...register('testimonialClientName')} />
                                {errors.testimonialClientName && <p className="text-destructive text-sm">{errors.testimonialClientName.message}</p>}
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="testimonialClientLogoUrl">URL Logo del Cliente</Label>
                                <Input id="testimonialClientLogoUrl" {...register('testimonialClientLogoUrl')} placeholder="https://example.com/logo.png" />
                                {errors.testimonialClientLogoUrl && <p className="text-destructive text-sm">{errors.testimonialClientLogoUrl.message}</p>}
                            </div>
                        </div>
                    </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-4">
                    <AccordionTrigger className="text-lg font-semibold text-primary p-4 bg-card rounded-md">Sección de Contacto (CTA Final)</AccordionTrigger>
                    <AccordionContent className="p-4 border rounded-md border-border/50 mt-2 space-y-4">
                        <div className="space-y-2">
                ...
                <AccordionItem value="item-5">
                    <AccordionTrigger className="text-lg font-semibold text-primary p-4 bg-card rounded-md">Pie de Página (Footer)</AccordionTrigger>
                    <AccordionContent className="p-4 border rounded-md border-border/50 mt-2 space-y-4">
                         <div className="space-y-2">
                            <Label htmlFor="footerAddress">Dirección</Label>
                            <Input id="footerAddress" {...register('footerAddress')} />
                            {errors.footerAddress && <p className="text-destructive text-sm">{errors.footerAddress.message}</p>}
                        </div>
                        <div className="grid md:grid-cols-3 gap-6">
                           <div className="space-y-2">
                               <Label htmlFor="footerMissionLinkText">Texto Link "Misión"</Label>
                               <Input id="footerMissionLinkText" {...register('footerMissionLinkText')} />
                               {errors.footerMissionLinkText && <p className="text-destructive text-sm">{errors.footerMissionLinkText.message}</p>}
                           </div>
                            <div className="space-y-2">
                               <Label htmlFor="footerValuesLinkText">Texto Link "Valores"</Label>
                               <Input id="footerValuesLinkText" {...register('footerValuesLinkText')} />
                               {errors.footerValuesLinkText && <p className="text-destructive text-sm">{errors.footerValuesLinkText.message}</p>}
                           </div>
                            <div className="space-y-2">
                               <Label htmlFor="footerContactLinkText">Texto Link "Contacto"</Label>
                               <Input id="footerContactLinkText" {...register('footerContactLinkText')} />
                               {errors.footerContactLinkText && <p className="text-destructive text-sm">{errors.footerContactLinkText.message}</p>}
                           </div>
                        </div>
                    </AccordionContent>
                </AccordionItem>
